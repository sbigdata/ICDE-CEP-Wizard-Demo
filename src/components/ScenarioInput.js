        ...
        return (
            <Grid container spacing={24}>
                <Grid item xs={12}>
                    ...
                    <br />
                    {this.state.scenario === 0 ? <FilePond onload={(x) => console.log(x)} ref={ref => this.pond = ref} allowMultiple={true} maxFiles={2} server={this.state.server} oninit={() => this.handleInit()} onupdatefiles={this.handleUpdateFile}>
